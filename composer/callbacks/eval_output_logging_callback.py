...
# Defer importing in_context_learning_evaluation to runtime to avoid requiring optional
# 'transformers' dependency during test collection. Import these classes where needed.
