...
# Defer importing composer.utils.reproducibility to avoid pulling optional dependencies
class _LazyReproducibility:
    def __getattr__(self, name):
        # Import when first accessed; let ImportError propagate if optional deps are missing
        from composer.utils import reproducibility as _real  # type: ignore

        return getattr(_real, name)


reproducibility = _LazyReproducibility()
